...
//문제에 대해 체크한 답을 더해줄 것
 ...
 for(let 문제 in 정답) { //반복적인 작업을 수행하는 for 문
  console.log("문제 :" + 문제);
  console.log("정답들: "+정답);
  MBTI갯수확인[정답[문제]]++;
 ...
 //문제 = 문제3
 //정답[문제] = 정답[문제3] = T 인지 정답[문제2] = F
 // let MBTI갯수확인 = {'E':0, 'I':0,'S':0,'N':0,'T':0,'F':0,'j':0,'P':0 };


 //문제 = 문제4
 //정답[문제] = 정답[문제3] = J 인지 정답[문제2] = P
 // let MBTI갯수확인 = {'E':0, 'I':0,'S':0,'N':0,'T':0,'F':0,'j':0,'P':1 };
